...
public sealed class SubConsumer<TMessage> : IContainsChannel, IConsumer<TMessage>
{
    ...
    public async ValueTask<MessageId> GetLastMessageId(CancellationToken cancellationToken)
    {
        ...
        return await _channel.Send(getLastMessageId, cancellationToken).ConfigureAwait(false);
    }
    ...
    public async ValueTask<ConsumerState> OnStateChangeFrom(ConsumerState state, CancellationToken cancellationToken = default)
        => await _state.StateChangedFrom(state, cancellationToken).ConfigureAwait(false);


    public async ValueTask<ConsumerState> OnStateChangeTo(ConsumerState state, CancellationToken cancellationToken = default)
